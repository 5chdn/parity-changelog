...
### [nightly](https://github.com/paritytech/parity/releases/tag/nightly)
...
- EIP-86 [#4697](https://github.com/paritytech/parity/pull/4697)
- [beta] registry backports [#5445](https://github.com/paritytech/parity/pull/5445)
...
### [beta-release](https://github.com/paritytech/parity/releases/tag/beta-release)
...
### [stable-release](https://github.com/paritytech/parity/releases/tag/stable-release)
...
- Bump multihash, libc and nanomsg [#4957](https://github.com/paritytech/parity/pull/4957)
...
### [v1.5.10](https://github.com/paritytech/parity/releases/tag/v1.5.10)
...
- Secretstore DKG protocol draft + distributed encryption/decryption tests [#4725](https://github.com/paritytech/parity/pull/4725)
- Update parity-ui-precompiled with branch [#4850](https://github.com/paritytech/parity/pull/4850)
- Base infrastructure/contracts deployment dapp [#4726](https://github.com/paritytech/parity/pull/4726)
...
- removed redundant FixedHash trait, fixes #4029 [#4866](https://github.com/paritytech/parity/pull/4866)
...
### [v1.6.1](https://github.com/paritytech/parity/releases/tag/v1.6.1)
...
- Refactoring of the Dapp Registry [#4589](https://github.com/paritytech/parity/pull/4589)
...
### [v1.6.0](https://github.com/paritytech/parity/releases/tag/v1.6.0)
...
### [v1.5.8](https://github.com/paritytech/parity/releases/tag/v1.5.8)
...
- Fix validator contract syncing [#4789](https://github.com/paritytech/parity/pull/4789)
- Remote transaction execution [#4684](https://github.com/paritytech/parity/pull/4684)
...
- Re-Introducing HappyPack [#4669](https://github.com/paritytech/parity/pull/4669)
...
- Allow specifying extra cors headers for dapps [#4710](https://github.com/paritytech/parity/pull/4710)
- Version bump to 1.7.0 [#4730](https://github.com/paritytech/parity/pull/4730)
- Bump package.json for master 1.7 [#4731](https://github.com/paritytech/parity/pull/4731)
...
### [v1.5.0](https://github.com/paritytech/parity/releases/tag/v1.5.0)
...
- AuthorityRound network simulation test [#3775](https://github.com/paritytech/parity/pull/3775)
...
- Fixing serde overflow error (#1977) [#2031](https://github.com/paritytech/parity/pull/2031)
...
### [v1.3.0](https://github.com/paritytech/parity/releases/tag/v1.3.0)
...
- Backports to stable [#1887](https://github.com/paritytech/parity/pull/1887)
...
- Miner tweaks (#1797) [#1862](https://github.com/paritytech/parity/pull/1862)
...
- Unlock account with timeout for geth compatibility (#1854) [#1858](https://github.com/paritytech/parity/pull/1858)
- Backport fixes to stable [#1855](https://github.com/paritytech/parity/pull/1855)
...
- (STABLE) Updating crossbeam version to compile stable on rust beta [#1521](https://github.com/paritytech/parity/pull/1521)
...
### [v1.2.0](https://github.com/paritytech/parity/releases/tag/v1.2.0)
...
- (BETA) dependencies refactoring backport + fix hyper mio reference [#1069](https://github.com/paritytech/parity/pull/1069)
...
- (BETA) update hyper branch mio [#1055](https://github.com/paritytech/parity/pull/1055)
- Updating hyper-mio revision (beta) [#1049](https://github.com/paritytech/parity/pull/1049)
